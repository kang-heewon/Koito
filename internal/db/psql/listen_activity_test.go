	...
	err = store.Exec(context.Background(),
		`INSERT INTO listens (user_id, track_id, listened_at)
			VALUES (1, 1, NOW() - INTERVAL '1 month 1 day'),
				   ...
				   (1, 1, NOW() - INTERVAL '4 months 1 day'),
				   (1, 1, NOW() - INTERVAL '5 months 1 day'),
				   (1, 1, NOW() - INTERVAL '6 months 1 day'),
				   (1, 1, NOW() - INTERVAL '7 months 1 day'),
				   (1, 1, NOW() - INTERVAL '8 months 1 day'),
				   (1, 2, NOW() - INTERVAL '1 month 1 day'),
